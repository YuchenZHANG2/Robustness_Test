...
def execute_test():
    ...
    def run_test_background():
        ...
        try:
            ...
            use_batch = torch.cuda.is_available()
            ...
            def progress_callback(current, total, message):
                ...
                print(f"[PROGRESS UPDATE] {current}/{total} ({test_progress['progress']}%) - {message}")
                import sys
                sys.stdout.flush()
            ...
            test_progress['message'] = f'Test completed using {"GPU batch processing" if use_batch else "CPU processing"}!'
